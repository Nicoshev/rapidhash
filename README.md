...
Family of three hash functions: rapidhash, rapidhashJumbo and rapidhashNano.
...
Clang-18+ compiles it to ~140 instructions on both aarch64 and x86, without stack usage on aarch64.
Faster than rapidhashJumbo for sizes up to 512 bytes, just 15%-20% slower for inputs above 1kb.
Faster than rapidhashNano for sizes larger than 240 bytes, slightly slower for smaller inputs.
...
Clang-18+ compiles it to less than 100 instructions on both aarch64 and x86, without stack usage on aarch64.
...
Outstanding collision ratio when testing rapidhashJumbo on datasets of 16B and 67B keys:
...
| Hash      | M1 Pro | M4     | Neoverse V2 | AMD Turin | Ryzen 9700X |
| ---       | ---    | ---    | ---         | ---       | ---         |
| rapidhash | 1.78ns | 1.14ns | 1.97ns      | 2.31ns    | 1.46ns      |
| xxh3      | 1.92ns | 1.24ns | 2.15ns      | 2.35ns    | 1.45ns      |

Peak throughput when hashing files of 16Kb-2Mb

| Hash           | M1 Pro | M3 Pro | M3 Ultra | M4     | Neoverse V2 | Ryzen 9700X |
| ---            | ---    | ---    | ---      | ---    | ---         | ---         |
| rapidhashJumbo | 47GB/s | 57GB/s | 61GB/s   | 71GB/s | 38GB/s      | 68GB/s      |
| rapidhash      | 39GB/s |  -GB/s |  -GB/s   | 58GB/s | 35GB/s      |  -GB/s      |
